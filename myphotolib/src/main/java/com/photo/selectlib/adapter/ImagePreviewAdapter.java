 ...
 * 图片选择目录适配器
 */
public class ImagePreviewAdapter extends BaseRecyclerAdapter<ImageFolderBean, RecyclerView.ViewHolder> {


	public ImagePreviewAdapter(Context context, List<ImageFolderBean> list) {
		super(context, list);
