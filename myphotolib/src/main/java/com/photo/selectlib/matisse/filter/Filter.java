package com.photo.selectlib.matisse.filter;/*
...
/**
 * Filter for choosing a {@link }. You can add multiple Filters through
 */
...
public abstract class Filter {
     ...
     *
     * @return null if selectable, {@link } if not selectable.
     */
