...
//
//    private static final int placeholderRes = R.color.album_finish;
//    private static final int errorRes = R.color.album_finish;
//
...
//     * 加载圆角图片。
//     */
//    public static void loadRoundedCorners(Context context, String url, ImageView imageView, int roundingRadius) {
//        Glide.with(context)
//                .load(url)
//                .apply(baseOptions).apply(new RequestOptions()
